...
const Section2Component = ({
  ...
  const questions = [
    ...
    {
      id: "q10",
      label: "10. 암 진단 및 치료 이후, 규칙적인 운동을 하고 있다.",
    },
    { id: "q11", label: "11. 규칙적인 식사를 한다." },
    {
      id: "q12",
      label: "12. 나는 내가 생각한 건강관리 방법을 잘 실천하고 있다.",
    },
  ...
  const sub13 = [
    ...
    { id: "q13_1_5", num: "5)", text: "탄수화물 섭취를 조절한다." },
    {
      id: "q13_1_6",
      num: "6)",
      text: "항암식품(예: 버섯, 도라지, 두유, 현미식 등)을 먹는다.",
    },
  ];
  ...
  const handleRadio = (e) => {
    ...
    if (qId === "q12" && ["3", "4", "5"].includes(value)) {
      ...
      if (
        !updated.q9 ||
        (typeof updated.q9 === "string" && updated.q9.trim() === "") ||
        !updated.q10 ||
        (typeof updated.q10 === "string" && updated.q10.trim() === "") ||
        !updated.q11 ||
        (typeof updated.q11 === "string" && updated.q11.trim() === "")
      ) {
    ...
    >
              ...
              {setValidationError &&
                ...
                validationError && (
                  ...
                  >
                    <Typography
                      variant="body2"
                      sx={{ color: "#d84315", fontWeight: 600 }}
                    >
      ...
      >
        <FormLabel
          ...
          sx={{
            fontWeight: "bold",
            color: missingQuestions.includes("q13")
              ? "error.main"
              : "primary.main",
          }}
        >
      ...
      {["4", "5"].includes(answers.q13) && (
        <Box sx={{ mb: 2 }}>
          <Typography
            ...
            sx={{ fontWeight: "bold", display: "block", mb: 1 }}
          >
            ※ 13-1. 아래 각각의 사항에 대해서 식이조절을 얼마나 잘 하는지 체크해
            주세요.
          </Typography>
          {sub13.map((item) => (
            <FormControl
            ...
            >
              <FormLabel
                component="legend"
                sx={{
                  color: missingQuestions.includes(item.id)
                    ? "error.main"
                    : "text.primary",
                }}
              >
